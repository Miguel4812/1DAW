...
public class Gestion
{
	...
	public static void main(String[] args)
	{
		...
		System.out.print("Luc�a ha sido traicionada (debe ser false): ");
	...
	public static void creaDatos()
	{
		...
		club.anadeMiembro(new Miembro("Rub�n", 25));


		creaRelacion("Ana", "Carlos", 12, 3, 2021, 15, 6, 2022);
		creaRelacion("Elena", "David", 21, 5, 2019, 30, 8, 2021);
		creaRelacion("Luc�a", "Javier", 16, 7, 2021, 18, 9, 2023);
		creaRelacion("Sof�a", "Daniel", 25, 4, 2021, 27, 6, 2022);
		creaRelacion("Mar�a", "Pedro", 9, 1, 2021, 11, 3, 2023);
		creaRelacion("Laura", "Jos�", 19, 6, 2021, 21, 8, 2022);
		...
		creaRelacion("Sara", "Rub�n", 15, 9, 2019, 17, 11, 2020);
		creaRelacion("David", "Sof�a", 10, 4, 2020, 12, 6, 2021);
		...
		creaRelacion("Jos�", "Carla", 2, 3, 2020, 4, 5, 2021);
		...
		creaRelacion("Luc�a", "Carlos", 16, 8, 2022, 18, 9, 2023);
	}
			...
			int diaIni, int mesIni, int annoIni, int diaFin, int mesFin, int annoFin)
	{
		...
		m1.añadeRelacion(m2, new Fecha(diaIni, mesIni, annoIni),
				new Fecha(diaFin, mesFin, annoFin));

		m2.añadeRelacion(m1, new Fecha(diaIni, mesIni, annoIni),
				new Fecha(diaFin, mesFin, annoFin));
	}
